                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div id="product-1" class="single-product">
                            ...
                            <div class="part-2">
                                <h3 class="product-title">Physiotherapy</h3>
                                <h4 class="product-old-price">$10.00</h4>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div id="product-2" class="single-product">
                            ...
                            <div class="part-2">
                                <h3 class="product-title">Mud Therapy</h3>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div id="product-3" class="single-product">
                            ...
                            <div class="part-2">
                                <h3 class="product-title">Neurotherapy</h3>
                                <h4 class="product-old-price">$9.99</h4>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div id="product-4" class="single-product">
                            ...
                            <div class="part-2">
                                <h3 class="product-title">Neck Massage</h3>
                                <h4 class="product-price">$3.99</h4>
                            </div>
                        </div>
                    </div>
